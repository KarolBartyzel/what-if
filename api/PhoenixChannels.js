...
export class Channel {
   ...
   */
  off(event, ref) {
    this.bindings = this.bindings.filter((bind) => !(bind.event === event && (typeof ref === 'undefined' || ref === bind.ref)));
  }
...
export class Socket {
  ...
  sendHeartbeat() {
    ...
    this.push({
      topic: 'phoenix', event: 'heartbeat', payload: {}, ref: this.pendingHeartbeatRef,
    });
  }
